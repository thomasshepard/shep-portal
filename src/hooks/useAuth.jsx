...
export function AuthProvider({ children }) {
  ...
  const permissions = {
    ...
    can_view_fleet:      isAdmin || !!profile?.can_view_fleet,
    can_view_bookkeeping: isAdmin || !!profile?.can_view_bookkeeping,
    can_view_messages:    isAdmin || isVA || !!profile?.can_view_messages,
