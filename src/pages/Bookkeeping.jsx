...
export default function Bookkeeping() {
  ...
  // Equity (Owner's Draws) included too — a bank transaction that's really
  // the owner moving money to themselves needs a home in this same picker,
  // not just the separate Record Distribution flow.
